      ...
      <AnimatePresence mode="wait">
        {showName ? (
          ...
          <motion.div
            ...
            className="flex-1 flex flex-col"
          >
            <h1 className="font-display text-2xl font-semibold text-foreground mb-8 leading-tight">
              {steps[step].question}
            </h1>
              ...
              {steps[step].options.map((option, i) => (
                <motion.button
                  ...
                  className="w-full flex items-center gap-4 px-6 py-5 rounded-[24px] bg-card 
                    ...
                    hover:border-primary/30 hover:shadow-card active:bg-accent"
                >
            ...
            {step > 0 && (
              <button
                ...
                className="mt-6 text-muted-foreground text-sm btn-text self-center"
              >
                INDIETRO
              </button>
            )}
